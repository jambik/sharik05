...
class imageTransform
{
    ...
    function imageTransform()
    {
		...
		/**
     *  returns an source image's width and height and the image's type
     *
     *  @access private
     */
		function readSourceImageSize()
		{
			if(!list($this->sourceImageWidth, $this->sourceImageHeight, $this->sourceImageType) = @getimagesize($this->sourceFile))
			{
				$this->error = 4;
				return false;
			}
		...
		/**
     *  returns an target image's width and height and the image's type
     *
     *  @access private
     */
		function readTargetImageSize()
		{
			list($this->targetImageWidth, $this->targetImageHeight, $this->targetImageType) = @getimagesize($this->targetFile);
			return true;
		}
